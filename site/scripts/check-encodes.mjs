...
const PINNED = [
  { name: 'garden', bytes: 146678, says: 'the mobile hero encode' },
  { name: 'garden', bytes: 242118, says: 'the desktop hero encode' },
  { name: 'vine', bytes: 44148, says: 'the installer vine' },
  { name: 'seedling', bytes: 14390, says: 'the navigation seedling' },
]
